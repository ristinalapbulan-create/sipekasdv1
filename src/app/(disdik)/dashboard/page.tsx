    ...
    if (isLoading) {
        return (
            <div className="space-y-6">
                <h1 className="text-3xl font-bold text-slate-900">Dashboard Disdik</h1>
    ...
    return (
        <div className="space-y-6">
            <div>
                ...
                <p className="text-slate-500 mt-2">Ringkasan status pelaporan kegiatan PEKA Sekolah Dasar</p>
            </div>
